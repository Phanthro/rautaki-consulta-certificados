...
const Editarusuario = ({ params }) => {
    ...
    useEffect(() => {
        const consultaUser = async () => {
            ...
            const url = `${process.env.NEXT_PUBLIC_AVALON_CLIENTE_IP}/v1/Usuario/?usuarioId=${params.userId}`;

            const res = await enviaFormulario('', url, 'GET')

            setFormData(JSON.parse(res).dados)
    ...
    const handleSubmit = async (e) => {
        ...
        if (validarFormulario()) {
            ...
            formData.telefone = formData.telefone.replace("_", "");
            ...
            try {
                ...
                const resposta = await enviaFormulario(formData, url, 'PUT');
        ...
        <div className='bg-fundo-borda bg-contain bg-no-repeat bg-cor-principal text-black min-h-[600px]'>
            ...
            <form onSubmit={handleSubmit} className="p-2 datavalid m-auto w-2/3 ">
                ...
                <div className='flex flex-col gap-5 mb-10 items-center m-auto'>
                    ...
                    <div className='w-full border-b font-Inter text-lg text-center'> Alterar Usuário</div>
